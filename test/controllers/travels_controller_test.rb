...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post travels_url, params: { travel: { asientos: @travel.asientos, destino: @travel.destino, fecha: @travel.fecha, hora: @travel.hora, origen: @travel.origen, precio: @travel.precio, user_id: @travel.user_id } }
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { asientos: @travel.asientos, destino: @travel.destino, fecha: @travel.fecha, hora: @travel.hora, origen: @travel.origen, precio: @travel.precio, user_id: @travel.user_id } }
